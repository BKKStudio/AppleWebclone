...
import SearchModal from "../Navbar/SerchModal";
import BagModal from "../Navbar/BagModal";

export default function NavbarDontSlide() {
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            ...
            <div className="flex flex-col ">
              <p className={`text-xs text-gray-600 mb-2 `}>อีกมากมายจาก Mac</p>
              <Link
                href={""}
                className={`text-xs text-gray-600 mb-2 font-bold `}
              >
      ...
      >
        ...
        >
          ...
          >
            ...
            <div className="flex flex-col">
              <p className={`text-xs text-gray-600 mb-2 `}>อีกมากมายจาก iPad</p>
              <Link
                href={""}
                className={`text-xs text-gray-600 mb-2 font-bold `}
              >
      ...
      >
        ...
        >
          ...
          >
            ...
            <div className="flex flex-col ">
              <p className={`text-xs text-gray-600 mb-2 `}>เลือกซื้อ iPhone</p>
              <Link
                href={""}
                className={`text-xs text-gray-600 mb-2 font-bold `}
              >
      ...
      >
        ...
        >
          ...
          >
            <div className="flex flex-col ">
              <p className={`text-xs text-gray-600 mb-2 `}>ดูข้อมูล AirPods</p>
              <Link
                href={""}
                className={`text-xl text-gray-600 mb-2 font-bold `}
              >
            ...
            <div className="flex flex-col ">
              <p className={`text-xs text-gray-600 mb-2 `}>เลือกซื้อ AirPods</p>
              <Link
                href={""}
                className={`text-xs text-gray-600 mb-2 font-bold `}
              >
      ...
      >
        ...
        >
          ...
          >
            ...
            <div className="flex flex-col ">
              <p className={`text-xs text-gray-600 mb-2 `}>รับความช่วยเหลือ</p>
              <Link
                href={""}
                className={`text-xs text-gray-600 mb-2 font-bold `}
              >
